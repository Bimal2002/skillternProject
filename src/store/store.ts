...
import { reportApi } from '../pages/admin/report.service';
import reportReducer from '../pages/admin/report.slice';
import { couponApi } from '../pages/admin/Coupon/coupon.service'; // Import couponApi
import couponReducer from '../pages/admin/Coupon/coupon.slice'; // Import couponReducer
...
const rootReducer = combineReducers({
  ...
  report: reportReducer,
  [reportApi.reducerPath]: reportApi.reducer,
  coupon: couponReducer, // Add coupon reducer
  [couponApi.reducerPath]: couponApi.reducer, // Add couponApi reducer
});
...
export const store = configureStore({
  ...
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware().concat(
      ...
      authApi.middleware,
      reportApi.middleware,
      couponApi.middleware, // Add couponApi middleware
      rtkQueryErrorLogger
    ),
});
